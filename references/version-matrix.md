...
- `layui-vue`: `2.23.3`
- `layui-vue-admin`: use the local `layui-vue-admin-master` reference project, package version `2.0.0`, upgraded to `@layui/layui-vue 2.23.3`
- `Vue`: `3.3.13`
...
- Local admin layout references are based on the upgraded `layui-vue-admin-master` project in this workspace.
