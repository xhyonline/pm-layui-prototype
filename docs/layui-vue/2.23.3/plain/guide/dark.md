...
默认情况下，使用 layui-vue 搭建的网站主题为日间模式。


## 基本使用


若启用夜间模式, 将 <code>config-provider</code> 组件 <code>theme</code> 属性设置为 <code>dark</code> 值。
...
默认的夜间模式不满足要求时, 可通过 <code>config-provider</code> 组件 <code>dark-partial</code> 属性进行偏好设置。
